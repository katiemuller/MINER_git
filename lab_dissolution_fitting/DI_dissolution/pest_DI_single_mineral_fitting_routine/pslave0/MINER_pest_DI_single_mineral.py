...
# MINER- Lab Dissolution Experiments with DI for single minerals
# Katie Muller
# 06/06/24
...
model_fit = ["Total Ni++ [M] pt (1) (0.028 0.028 0.028)"]

for name in model_fit:
...
* parameter data
Ni2SiO4_rate_constant            none  relative    1.0e-7      7.85e-8   2 dgr             7.85e-7       0.0000      1
* observation groups
obsgroup
* observation data
